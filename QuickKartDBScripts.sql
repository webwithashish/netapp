...
CREATE TABLE [dbo].[ProductDetails] (
    ...
    CONSTRAINT [fk_ProdId] FOREIGN KEY ([ProductId]) REFERENCES [dbo].[Products],
    CONSTRAINT [chk_Ratings] CHECK ([Ratings] BETWEEN 1 AND 5),
...
INSERT INTO CardDetails(CardNumber,NameOnCard,CardType,CVVNumber,ExpiryDate,Balance) VALUES(2107089108224360,'Latimer','V',720,DATEADD(YEAR, 10,GETDATE()),11387.00)
...
INSERT INTO Rating VALUES ('Albert@gmail.com', 'P101', 'Lamborghini Gallardo Spyder', 5, 'Luxurious')
INSERT INTO Rating VALUES ('Carine@gmail.com', 'P143', 'Adidas Shoes', 4, 'Good to wear')
INSERT INTO Rating VALUES ('Helen@gmail.com', 'P155', 'Teddy bear', 4, 'Cute')
GO

INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P143','Adidas Shoes','Great everyday trainer for modern runner to go that extra mile','ADIDAS Outlet',4)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P102','BMW X1','Five seater SUV with 19.62 kMPL milage and 257 BHP','BMW motors',4)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P115','Apple IPhone 5s 16GB','7th generation IPhone which introduce the A7 64 Bit dual core system on chip','Apple',5)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P121','Dell Inspiron','Portable thin and light design laptop with the new intel core processor','COMP Pro',4)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P117','Nokia Lumia 1320','Phablet smartphone in the Lumia series that runs windows phone OS','Phone Planet',3)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P106','Honda CBR 250R','Twin cylinder spot bike having 14.5 liters fuel capacity','Dream Honda',4)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P145','Baseball glove','12.5 INCH left hand glove/hand throw ball','Pilot Sports',2)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P137','Curtains','Made with 100% high quality polyester which has resistance to shrinkage','HomeDecors',5)
INSERT INTO ProductDetails(ProductId,ProductName,Description,Seller,Ratings) VALUES('P122','IPad Air','This new Apple product has an all-screen design,10" display,M1 Chip,Centre Stage and works with Apple Pencil','PreiumSmartphones',5)
